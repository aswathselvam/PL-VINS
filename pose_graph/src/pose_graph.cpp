...
void PoseGraph::addKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop)
{
    ...
    if (SAVE_LOOP_PATH)
    {
        ...
        ofstream foutC("/home/aswath/catkin_plvins/src/PL-VINS/Trajactory/tum_fast_plvins_loop.txt", ios::app);
        ...
        ofstream foutC1("/home/aswath/catkin_plvins/src/PL-VINS/Trajactory/evo_fast_plvins_loop.txt", ios::app);
